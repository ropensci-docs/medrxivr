...
![Diagram comparing medRxiv data access from the live API and static
snapshot](articles/data_sources.png)
...
to export references for preprints matching your search results to a
...
function to download a copy of the PDF for each record found by your
search.
